...
We will release one canonical artifact, in which all annotations have runtime
...
Tools are encouraged to treat an illegally placed annotation in Java source code
